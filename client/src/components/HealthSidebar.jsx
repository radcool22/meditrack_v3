  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-1.5 w-full border-2 border-ink-200 focus:border-teal-600 rounded-xl px-3 py-2.5 text-[15px] font-medium text-ink-900 outline-none bg-white transition-colors placeholder-ink-400"
      />
    </label>
  )
}
        ...
        {['male', 'female'].map((g) => (
          <button
            ...
            className={`flex-1 text-[13px] font-semibold py-2 rounded-lg transition-all capitalize ${
              value === g ? 'bg-card text-teal-700 shadow-sm' : 'text-ink-400 hover:text-ink-900'
            }`}
          >
    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <select
          ...
          className="mt-1.5 w-full border-2 border-ink-200 focus:border-teal-600 rounded-xl px-3 py-2.5 text-[13px] font-medium text-ink-900 bg-white outline-none transition-colors"
        >
...
function SidebarContent() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="bg-teal-900 px-5 pt-5 pb-4">
        <h2 className="text-[17px] font-bold text-white tracking-tight">{t('health_tools')}</h2>
        <p className="text-[13px] text-teal-100/70 mt-0.5 font-medium">{t('quick_calculators')}</p>
      </div>
      ...
      <div className="hidden lg:block">
        ...
        >
          <button
            ...
            className="absolute top-4 right-4 text-teal-100/70 hover:text-white transition-colors z-10"
          >
        ...
        >
          <div className="bg-teal-700 hover:bg-teal-600 text-white flex items-center justify-center rounded-l-xl w-8 py-7 transition-colors shadow-lg">
            <span
      ...
      <div className="lg:hidden">
        {!open && (
          <button
            ...
            className="fixed bottom-5 right-5 z-50 w-14 h-14 bg-teal-700 hover:bg-teal-600 text-white rounded-full flex items-center justify-center shadow-xl transition-colors"
          >
